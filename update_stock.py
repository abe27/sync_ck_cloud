...
def main():
    ...
    Oracur.execute(f"UPDATE TXP_CARTONDETAILS SET RECLOCATE=SHELVE,SIDTE=NULL,SINO=NULL,SIID=NULL WHERE STOCKQUANTITY > 0 AND SHELVE IN ('S-PLOUT', 'S-CK1') AND TAPKANBANID IS NULL")
