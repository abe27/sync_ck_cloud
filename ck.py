...
def genearate_order():
    ...
    select a.* from (
        ...
        where is_generated=false and order_group is not null and to_char(etdtap, 'yyyy') = to_char(current_date, 'yyyy') and etdtap between date_trunc('week', current_date)::date and date_trunc('week', current_date) + '13 days'
